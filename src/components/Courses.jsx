...
const courses = [
  ...
  { id: 7, name: "JavaScript e TypeScript", level: 15, Icon: TbBrandTypescript , type: "Udemy" },
  { id: 8, name: "Ingles", level: 80, Icon: TbSortAscendingLetters, type: "CCAA" },
  { id: 9, name: "Espanhol", level: 15, Icon: TbSortAscendingLetters, type: "Duolingo" },
  //{ id: 10, name: "Cyber Security", level: 10, Icon: TbSortAscendingLetters, type: "Udemy" },
